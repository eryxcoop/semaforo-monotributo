...
test('When there is one month left, and the limit for the period cant be reached, the totality of the salary is suggested in pesos', () => {
...
test('When there is one month left, and the limit for the period can be reached, the suggested salary is the maximum before going over the limit', () => {
    let previous_salaries_during_period: Peso[] = [10, 10]
    let total_salary_for_current_month: Peso = 10
    let months_left_in_the_period: number = 1
